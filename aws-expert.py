...
def summarize_content(transcript):
    system_prompt = """You are an expert tasked with summarizing lessons on AWS . 
    Generate a summary of the main topics covered in the lesson and provide a basic AWS code example.
