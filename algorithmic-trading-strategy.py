...
def summarize_content(transcript):
    system_prompt = """You are an assistant tasked with summarizing lessons on Algorithmic trading programming. 
    Generate a summary of the main topics covered in the lesson and provide a basic Algorithmic trading code example.
    Additionally, generate a few review questions based on the content of the lesson."""
    
    user_prompt = f"Transcript content: {transcript}\n\nSummarize the content and generate a Algorithmic trading example with review questions."
...
st.title("Tool summarizer script Algorithmic trading")
